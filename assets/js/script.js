...
var getRecipeData = function () {
  ...
  var apiUrl =
    beginRecipeUrl + randomFood + "&" + edamamApiId + "&" + edamamApiKey;
  var stringBuilder = "";
    ...
    if (response.ok) {
      response.json().then(function (data) {
        ...
        for (i = 0; i < randomRecipe.recipe.ingredients.length; i++) {
          ...
          liEl.textContent = randomRecipe.recipe.ingredients[i].text;
          ingredientBody.appendChild(liEl);
        }
      });
    }
  });
...
var getAllExercise = function () {
  ...
  if (muscleSelectGroup == "Upper Body") {
    ...
    var upperBodyCategory =
      upperBodyGroup[Math.floor(Math.random() * upperBodyGroup.length)];
    getExerciseList(upperBodyCategory);
  } else if (muscleSelectGroup == "Lower Body") {
    var lowerBodyGroup = ["14", "9"];
    var lowerBodyCategory =
      lowerBodyGroup[Math.floor(Math.random() * lowerBodyGroup.length)];
...
var printExerciseWorkout = function () {
  ...
  if (firstName.value) {
    workoutWithName.textContent =
      "Hello " + firstName.value + ", below is your customized workout plan!";
  }
  ...
  if (workoutValue === "Mass") {
    workoutrep1.innerHTML =
      "<b>Sets: </b>" + massSetValue + ", <b>Reps: </b>" + massRepValue;
    workoutrep2.innerHTML =
      "<b>Sets: </b>" + massSetValue + ", <b>Reps: </b>" + massRepValue;
    workoutrep3.innerHTML =
      "<b>Sets: </b>" + massSetValue + ", <b>Reps: </b>" + massRepValue;
  } else if (workoutValue === "Lean") {
    workoutrep1.innerHTML =
      "<b>Sets: </b>" + leanSetValue + ", <b>Reps: </b>" + leanRepValue;
    workoutrep2.innerHTML =
      "<b>Sets: </b>" + leanSetValue + ", <b>Reps: </b>" + leanRepValue;
    workoutrep3.innerHTML =
      "<b>Sets: </b>" + leanSetValue + ", <b>Reps: </b>" + leanRepValue;
    ...
    workoutrep1.innerHTML =
      "<b>Sets: </b>" + eduranceSetValue + ", <b>Reps: </b>" + eduranceRepValue;
    workoutrep2.innerHTML =
      "<b>Sets: </b>" + eduranceSetValue + ", <b>Reps: </b>" + eduranceRepValue;
    workoutrep3.innerHTML =
      "<b>Sets: </b>" + eduranceSetValue + ", <b>Reps: </b>" + eduranceRepValue;
